...
class Share(Base):
    ...
    user_whitelist: Mapped[str | None] = mapped_column(
...
class User(Base):
    ...
    password: Mapped[str | None] = mapped_column(String(128), nullable=True, default=None)
    public_keys: Mapped[list[PublicKey]] = relationship("PublicKey", default_factory=list)
    reset_token: Mapped[str | None] = mapped_column(String(36), nullable=True, default=None)
